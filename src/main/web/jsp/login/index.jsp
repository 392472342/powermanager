...
<html>
	<head>
		...
		<title>登录界面</title>
		<link href="<%=basePath%>static/login/css/default.css" rel="stylesheet" type="text/css" />
		<!--必要样式-->
		<link href="<%=basePath%>static/login/css/styles.css" rel="stylesheet" type="text/css" />
		<link href="<%=basePath%>static/login/css/demo.css" rel="stylesheet" type="text/css" />
		<link href="<%=basePath%>static/login/css/loaders.css" rel="stylesheet" type="text/css" />
	</head>
	...
	<body>
		<div class='login'>
			...
			<div class='login_fields'>
				...
				<div class='login_fields__password'>
					...
					<div class='validation' style="cursor: pointer">
						<img alt="" src='<%=basePath%>static/login/img/tick.png' >
					</div>
				</div>
				<div class='login_fields__password'>
					<div class='icon'>
						<img alt="" src='<%=basePath%>static/login/img/key.png'>
					</div>
					<input name="code" id="code" placeholder='验证码' maxlength="4" type='text' name="ValidateNum" autocomplete="off">
					<div class='validation' style="opacity: 1; right: -5px;top: -3px;">
						<img src="<%=basePath%>util/code" id="code_img" onclick="changeimg(this)">
					</div>
				</div>
		...
		<script type="text/javascript" src='<%=basePath%>static/login/js/stopExecutionOnTimeout.js?t=1'></script>
		<script src="<%=basePath%>static/login/layui/layui.js" type="text/javascript"></script>
		<script src="<%=basePath%>static/login/js/Particleground.js" type="text/javascript"></script>
		<script src="<%=basePath%>static/login/js/Treatment.js" type="text/javascript"></script>
		<script src="<%=basePath%>static/login/js/jquery.mockjax.js" type="text/javascript"></script>
		<script type="text/javascript">

			function changeimg(img)
			{
			    var url='<%=basePath%>util/code?t='+new Date()
			    $(img).attr('src',url)
			}
		...
		<script type="text/javascript" src="<%=basePath%>static/login/img/ThreeWebGL.js"></script>
		<script type="text/javascript" src="<%=basePath%>static/login/img/ThreeExtras.js"></script>
		<script type="text/javascript" src="<%=basePath%>static/login/img/Detector.js"></script>
		<script type="text/javascript" src="<%=basePath%>static/login/img/RequestAnimationFrame.js"></script>
